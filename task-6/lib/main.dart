...
//     return Scaffold(
//       body: IntroductionScreen(
//         globalBackgroundColor: const Color(0xFF42A5F5),
//         pages: listPagesViewModel(),
//         onDone: () {
...
//       PageViewModel(
//           image: Center(
//             child: Image.asset('pictures/yoga'),
//           ),
//           title: 'yoga surge',
//           body: 'Welcome to Yoga World',
//           footer: const Text('Inhale the future, Exhale the Past'),
...
//       PageViewModel(
//           image: Center(
//             child: Image.asset("pictures/welcome.png"),
//           ),
//           title: 'Healthy Freak Exercises',
//           body: 'Letting Go is the Hardest Part',
//           decoration: const PageDecoration(
...
//       PageViewModel(
//           image: Center(
//             child: Image.asset("pictures/cycling"),
//           ),
//           title: 'Cycling',
//           body:
//           'You cannot always control what goes on outside. But you can always control what goes on inside.',
...
//       PageViewModel(
//           image: Center(
//             child: Image.asset("pictures/meditation.png"),
//           ),
//           title: 'Mediation',
//           body: 'The longest journey of any person is the journey inwards.',
//           decoration: const PageDecoration(
...
//                   children: <Widget>[
//                     Image.asset('pictures/welccome.png'),
//                     const Text('Nikhil Reddy', textScaleFactor: 3),
//                     const Text(
//                       'Hey there , My discord alias is NightKing',
//                       textScaleFactor: 1,
//                     )
//                   ])
//             ]));
